...
\item Definir un formato de logs estructurado que facilite el almacenamiento y tratamiento de la información generada por los distintos dispositivos.
...
\item Diseñar una arquitectura modular que facilite futuras ampliaciones y mejoras del sistema.
\end{itemize}
