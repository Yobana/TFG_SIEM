...
\item Incorporar un sistema de notificaciones Short Message Service (SMS) para alertas críticas.
...
\item Aplicar criterios de supervisión y protección inspirados en las necesidades de seguridad presentes en infraestructuras críticas y depósitos de material sensible, tomando como referencia normativa nacional y recomendaciones utilizadas en entornos de defensa.
\end{itemize}
...
\item Utilizar tecnologías actuales de desarrollo como Python \cite{python}, SQLite \cite{sqlite}, FastAPI \cite{fastapi}y Streamlit \cite{streamlit}.
\item Diseñar una solución modular y fácilmente mantenible.
\item Aplicar buenas prácticas de desarrollo y control de versiones mediante Git \cite{git} y GitHub \cite{github}.
