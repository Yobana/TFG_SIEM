...
\imagen{img/siem_flujo}{Flujo general de funcionamiento de un sistema SIEM.}{0.35}
...
\imagen{img/polvorín}{Esquema simplificado del entorno de polvorín militar simulado utilizado durante el desarrollo del proyecto.}{0.35}
