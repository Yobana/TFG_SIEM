...
\begin{figure}[H]
	...
	\includegraphics[width=0.85\textwidth]{imagenes/swagger_api.png}
	
	\vspace{0.3cm}
	
	\includegraphics[width=0.85\textwidth]{imagenes/swagger_events.png}
...
\imagen{img/dashboard_principal4}
...
{Distribución de alertas clasificadas según su nivel de severidad.}
{0.80}
